# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-28 15:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('airtable_id', models.CharField(blank=True, max_length=50, null=True)),
                ('areas', models.ManyToManyField(to='register.BusinessArea')),
                ('categories', models.ManyToManyField(to='register.Category')),
